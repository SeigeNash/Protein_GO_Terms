...
elastic_net_regressor = ElasticNet(alpha=1.0, l1_ratio=0.5)  # You can adjust alpha and l1_ratio as needed
elastic_net_regressor.fit(x.reshape(-1,1), y_train)

# Make predictions
elastic_net_predictions = elastic_net_regressor.predict(x_.reshape(-1,1))
